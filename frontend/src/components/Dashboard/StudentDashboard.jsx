...
const StudentDashboard = () => {
  ...
  const fetchCompanies = async () => {
    try {
      const token = localStorage.getItem('token');
      console.log('Fetching companies for student with token:', token ? 'Token exists' : 'No token');
      ...
      if (response.ok) {
        ...
        console.log('Companies data for student:', data);
        setCompanies(data);
      } else {
    ...
    <div className="dashboard">
      ...
      <main className="dashboard-main">
        <div className="search-section">
          <h2 className="section-title">Find Companies</h2>
          <p className="section-subtitle">Search for companies and prepare for placements with alumni reviews</p>
        ...
        <div className="companies-section">
          <div className="companies-header">
            ...
            <p className="companies-subtitle">
              Click on a company to view details and placement experiences
            </p>
          </div>
